...
#		BOOST_INCLUDE_PATH=/usr/local/boost-1_61_0/include
#		BOOST_LIB_PATH=/usr/local/boost-1_61_0/lib
...
macx:ICON = src/qt/res/icons/hochiminh.icns
macx:TARGET = "HoChiMinh-Qt"

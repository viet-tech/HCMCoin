...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        gridLayout->addItem(horizontalSpacer_8, 8, 2, 1, 1);
        ...
        gridLayout->addItem(horizontalSpacer_9, 9, 2, 1, 1);

        horizontalSpacer_10 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_10, 10, 2, 1, 1);

        horizontalSpacer_11 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_11, 11, 2, 1, 1);

        horizontalSpacer_12 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_12, 12, 2, 1, 1);

        horizontalSpacer_13 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_13, 15, 2, 1, 1);

        horizontalSpacer_14 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_14, 16, 2, 1, 1);

        horizontalSpacer_15 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_15, 17, 2, 1, 1);

        label_15 = new QLabel(tab_info);
        label_15->setObjectName(QString::fromUtf8("label_15"));
        label_15->setPixmap(QPixmap(QString::fromUtf8(":/images/small_logo")));
        label_15->setScaledContents(false);

        gridLayout->addWidget(label_15, 15, 3, 3, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "hochiminh - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        label_9->setText(QApplication::translate("RPCConsole", "hochiminh Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the hochiminh debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the hochiminh-Qt help message to get a list with possible hochiminh command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP

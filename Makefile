#############################################################################
# Makefile for building: HoChiMinh-Qt.app/Contents/MacOS/HoChiMinh-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Aug 14 12:32:23 2016
# Project:  hcm-qt.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP=- USE_QRCODE=1 RELEASE=1 -o Makefile hcm-qt.pro
#############################################################################
...
CFLAGS        = -pipe -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -stdlib=libc++ -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk -O2 -arch x86_64 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -fpermissive -mmacosx-version-min=10.7 -stdlib=libc++ -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk -fstack-protector-all --param ssp-buffer-size=1 -O2 -arch x86_64 -pthread -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
LINK          = clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -stdlib=libc++ -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk -fstack-protector-all --param ssp-buffer-size=1 -arch x86_64 -pthread
LIBS          = $(SUBLIBS) -F/usr/local/Cellar/qt/4.8.7_2/lib -L/usr/local/Cellar/qt/4.8.7_2/lib -lqrencode /Volumes/MacOSX/github/hcm/src/leveldb/libleveldb.a /Volumes/MacOSX/github/hcm/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -framework CoreServices -L/usr/local/opt/boost155/lib -L/usr/local/Cellar/berkeley-db4/4.8.30/lib -L/usr/local/opt/openssl/lib -L/usr/local/opt/qrencode/lib -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -lboost_date_time-mt -lboost_chrono-mt -framework QtGui -L/usr/local/Cellar/qt/4.8.7_2/lib -F/usr/local/Cellar/qt/4.8.7_2/lib -framework QtCore 
AR            = ar cq
RANLIB        = ranlib -s
...
DIST          = /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
		...
		hcm-qt.pro
QMAKE_TARGET  = HoChiMinh-Qt
DESTDIR       = 
TARGET        = HoChiMinh-Qt.app/Contents/MacOS/HoChiMinh-Qt
...
all: Makefile HoChiMinh-Qt.app/Contents/PkgInfo HoChiMinh-Qt.app/Contents/Resources/empty.lproj HoChiMinh-Qt.app/Contents/Info.plist HoChiMinh-Qt.app/Contents/Resources/hochiminh.icns $(TARGET)

$(TARGET): /Volumes/MacOSX/github/hcm/src/leveldb/libleveldb.a /Volumes/MacOSX/github/hcm/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_statisticspage.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) HoChiMinh-Qt.app/Contents/MacOS/ || $(MKDIR) HoChiMinh-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: hcm-qt.pro  /usr/local/Cellar/qt/4.8.7_2/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.7_2/mkspecs/common/clang.conf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 RELEASE=1 -o Makefile hcm-qt.pro
...
distclean: clean
	-$(DEL_FILE) -r HoChiMinh-Qt.app
	-$(DEL_FILE) Makefile


/Volumes/MacOSX/github/hcm/src/leveldb/libleveldb.a: FORCE
	cd /Volumes/MacOSX/github/hcm/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-fpermissive -mmacosx-version-min=10.7 -stdlib=libc++ -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/Volumes/MacOSX/github/hcm/build/build.h: FORCE
	cd /Volumes/MacOSX/github/hcm; /bin/sh share/genbuild.sh /Volumes/MacOSX/github/hcm/build/build.h
...
build/moc_statisticspage.cpp: src/qt/clientmodel.h \
	...
	/usr/local/Cellar/qt/4.8.7_2/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/statisticspage.h -o build/moc_statisticspage.cpp
...
build/ui_statisticspage.h: src/qt/forms/statisticspage.ui
	/usr/local/Cellar/qt/4.8.7_2/bin/uic src/qt/forms/statisticspage.ui -o build/ui_statisticspage.h
